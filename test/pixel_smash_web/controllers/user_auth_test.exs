defmodule PixelSmashWeb.UserAuthTest do
  use PixelSmashWeb.ConnCase, async: true

  alias PixelSmash.Accounts
  alias PixelSmashWeb.UserAuth
  import PixelSmash.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PixelSmashWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PixelSmashWeb.Endpoint.subscribe(live_socket_id)
